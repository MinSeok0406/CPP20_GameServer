...
export
{
    ...
    template <std::size_t N>
    [[nodiscard]] inline ReadLockGuard READ_LOCK_IDX(LockBox<N>& box, std::size_t idx,
    ...
    template <std::size_t N>
    [[nodiscard]] inline WriteLockGuard WRITE_LOCK_IDX(LockBox<N>& box, std::size_t idx,
            std::source_location loc = std::source_location::current())
	{
    ...
    template <std::size_t N>
    [[nodiscard]] inline ReadLockGuard READ_LOCK(LockBox<N>& box, 
        std::source_location loc = std::source_location::current())
	{
    ...
    template <std::size_t N>
    [[nodiscard]] inline WriteLockGuard WRITE_LOCK(LockBox<N>& box, 
        std::source_location loc = std::source_location::current())
	{
